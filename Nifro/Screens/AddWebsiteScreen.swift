...
struct AddWebsiteScreen: View {
	...
	@State private var newWebsite: Website = {
		var website = Website(id: UUID(), url: ".", usePrintStyles: false)
	...
	*/
	...
	private var editingView: some View {
		...
		Section {
			...
			WebsiteReloadSetting(overridesReloadInterval: website.overridesReloadInterval, reloadInterval: website.reloadInterval)
