...
extension AppState {
	func showWelcomeScreenIfNeeded() {
		...
		NSAlert.showModal(
			title: "Welcome to Noren!",
			message:
				"""
				Noren lives in the menu bar (droplet icon at the top-right of the screen). Click it and then select “Add Website…” to get started.
