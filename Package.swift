...
let package = Package(
	...
	targets: [
		.target(
			name: "NifroLogic",
			path: "Nifro",
			sources: ["Support/DiskBudget.swift", "Support/Geometry.swift", "Support/UpdateCheck.swift", "Support/Rotation.swift", "Support/Schedule.swift", "Support/URLCommand.swift", "Support/VideoEmbed.swift"]
		),
		.testTarget(
			name: "NifroTests",
