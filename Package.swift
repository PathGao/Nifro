...
// website is current on which display and how often it changes, video embedding, URL commands and
// menu word wrapping. It reads
...
let package = Package(
	...
	targets: [
		.target(
			name: "NifroLogic",
			path: "Nifro",
			sources: ["Support/DiskBudget.swift", "Support/Geometry.swift", "Support/UpdateCheck.swift", "Support/Rotation.swift", "Support/RotationInterval.swift", "Support/Schedule.swift", "Support/URLCommand.swift", "Support/VideoEmbed.swift"]
		),
		.testTarget(
			name: "NifroTests",
